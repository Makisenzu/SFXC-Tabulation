import{r as c,j as e,H as o}from"./app-DfNBjzIH.js";function m({tally:s}){c.useEffect(()=>{window.print()},[]);const d=a=>{const n=s.scores.filter(r=>r.event_id===a.id),t={champion:[],first:[],second:[]};return n.forEach(r=>{const i=s.participants.find(l=>l.id===r.participant_id);i&&r.score>=1&&r.score<=3&&(r.score===3?t.champion.push(i.participant_name):r.score===2?t.first.push(i.participant_name):r.score===1&&t.second.push(i.participant_name))}),t};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:`${s.tally_title} - Cue Cards`}),e.jsx("style",{children:`
                @media print {
                    body { 
                        margin: 0;
                        padding: 0;
