import{r as o,j as e,H as c}from"./app-CJQL5-s2.js";function m({tally:s}){o.useEffect(()=>{window.print()},[]);const l=a=>{const n=s.scores.filter(r=>r.event_id===a.id),t={champion:[],first:[],second:[]};return n.forEach(r=>{const i=s.participants.find(d=>d.id===r.participant_id);i&&r.score>=1&&r.score<=3&&(r.score===3?t.champion.push(i.participant_name):r.score===2?t.first.push(i.participant_name):r.score===1&&t.second.push(i.participant_name))}),t};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:`${s.tally_title} - Cue Cards`}),e.jsx("style",{children:`
                @media print {
                    body { 
                        margin: 0;
                        padding: 0;
