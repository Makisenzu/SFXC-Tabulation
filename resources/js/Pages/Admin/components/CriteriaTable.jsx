...
// Add these modal handler functions with your other modal handlers
...
const closeAddJudgesModal = () => {
    ...
    // Add this modal component inside your EventCriteriaTable component, before the return statement
const AddMultipleJudgesModal = () => {
    ...
    useEffect(() => {
        if (showAddJudgesModal && selectedEventForJudges) {
            fetchJudges();
        }
    }, [showAddJudgesModal, selectedEventForJudges]);
    ...
    const handleSubmit = () => {
        ...
        const payload = {
            event_id: selectedEventForJudges.id,
    ...
    if (!selectedEventForJudges) return null;
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">
                                        {selectedEventForJudges.event_name}
                                    </p>
                                </div>
                            </div>
                            <button
    ...
    className="inline-flex items-center px-2 py-1 border border-gray-300 rounded text-xs font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors duration-150"
                    ...
                    {showAddJudgesModal && <AddMultipleJudgesModal />}
                </div>
